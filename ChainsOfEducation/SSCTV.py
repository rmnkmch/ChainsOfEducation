...
class SSCTV(object):
    ...
    tv2_F_s = 30.0
    tv2_R2 = 3.0 / 4.0
    tv2_R2_str = r"\frac {3}{4}"
    tv2_V_p = 24.04
    tv2_b_s = 5
    tv2_data1 = [9.0, 7.0, 5.0, 3.0, 1.0]
    tv2_data2 = [10.0, 8.0, 6.0, 4.0, 2.0]
    tv2_data3 = [16.2, 13.2, 10.2, 7.2, 4.2]
    tv2_data11 = [17.525, 15.375, 13.375, 11.55, 9.375]
    tv2_data22 = [21.825, 19.85, 17.675, 15.65, 13.7]
    tv2_data33 = [29.6, 26.95, 23.65, 20.9, 17.625]
    tv2_data111 = [0.000313, 0.004688, 0.016875, 0.045938, 0.0928]
    tv2_data222 = [0.002539, 0.01168025, 0.033125, 0.065078, 0.097228]
    tv2_data333 = [0.000293, 0.004662, 0.02672, 0.060353, 0.09798]
